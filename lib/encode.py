...
def get_models():
    ...
    # finetuned r100
    model1 = get_model("saved_models/s1_glint360k_r50_512d_gmdb__v1.1.5_bs64_size112_channels3_last_model.pth", device=device).eval()
    # original r100
    model2 = get_model("saved_models/s2_glint360k_r100_512d_gmdb__v1.1.5_bs128_size112_channels3_last_model.pth", device=device).eval()
    # mix
